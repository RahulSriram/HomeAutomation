...
#define BIT_OFFSET 4
#define MAX_BITS 4
#define MAX_ADDRESS int(pow(2,MAX_BITS))
#define state BIT_OFFSET+MAX_BITS
#define enable BIT_OFFSET+MAX_BITS+1
#define DEFAULT_TIMEOUT 1000

SoftwareSerial espSerial(3,2); //RX,TX

int address;
int addressBit[MAX_BITS];
boolean bitValue[MAX_BITS];
boolean switchState[MAX_ADDRESS];
...
boolean parseCommand(String input) {
  ...
  else {  //if this is not a client connection start, then parse the command
    String cmd;
